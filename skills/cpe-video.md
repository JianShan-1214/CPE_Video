...
從零建立一支 CPE Video 教學影片。
使用者提供 C++ 程式碼與題目說明，AI 自動切片、產生設定檔、逐步確認後生成語音音檔。

**觸發時機：** 使用者說「建新影片」「從零開始做影片」或明確呼叫此 skill。

---

## 前置知識

執行此 skill 前，先閱讀以下文件以了解專案結構與設定格式：

- `README.md` — 完整使用說明、config.json 欄位定義、highlight 色表
- `public/bubble_sort/config.json` — 實際範例（可參考步驟寫法）
